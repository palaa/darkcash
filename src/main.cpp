...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "vristog";
        CTransaction txNew;
        txNew.nTime = 1407203189;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("8a1b52cc7c9f0ee260cdff2976d908aa4a6d9417c5b4141d48b44bb5e32bb690"));
